...
<head>
    ...
    <style>
        ...
        .note { background: #fff8e1; padding: 10px; border-radius: 4px; margin-top: 15px; }
    </style>
</head>
<body>
<div class="container">
    ...
    %>
        <p class="success">Appointment request submitted! It is pending confirmation — you'll receive an email once confirmed.</p>
    <%
        }
    %>
    ...
    %>
        ...
        <form action="../BookAppointmentOnlineServlet" method="post">
            ...
            <p class="note">Note: Online bookings require confirmation from hospital staff. You'll receive an email once your appointment is confirmed.</p>
